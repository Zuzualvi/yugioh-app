 ...
 * the manifest.
 *
 * Maintained by the content team (Track C). Targets must exist in the manifest.
 */
export const QUICK_ANSWERS: QuickAnswer[] = [
  ...
  },
  {
    ...
    canonicalId: "rules.diff.06#related-cards",
  },
];
