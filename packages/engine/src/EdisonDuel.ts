...
const MSG_NAMES: Record<number, string> = {
  1: "HINT", 2: "PLAYER_HINT", 3: "CARD_HINT",
  ...
  26: "SELECT_UNSELECT_CARD", 30: "ROCK_PAPER_SCISSORS",
  31: "ANNOUNCE_RACE", 32: "ANNOUNCE_ATTRIB", 33: "ANNOUNCE_CARD",
  34: "ANNOUNCE_NUMBER", 40: "SUMMONED", 41: "SPSUMMONED",
  42: "FLIPSUMMONED", 43: "FLIPSUMMONING", 50: "MOVE",
  54: "SET", 60: "SHUFFLE_HAND", 67: "SHUFFLE_SET_CARD",
  80: "SHOW_HINT", 81: "CONFIRM_DECKTOP", 83: "CONFIRM_CARDS",
  85: "DECK_TOP", 86: "CONFIRM_EXTRATOP", 90: "DRAW",
  91: "DAMAGE", 92: "RECOVER", 100: "WIN",
};
...
export class EdisonDuel {
  ...
  step(): EngineStepResult {
    ...
    while (true) {
      ...
      if (result === OcgProcessResult.WAITING) {
        ...
        return { status: "waiting", messages, awaiting: awaitingSeat !== null ? { seat: awaitingSeat } : undefined };
      }
  ...
  respond(response: EngineResponse): void {
    ...
    this.lib.duelSetResponse(this.handle, response as Parameters<OcgCoreSync["duelSetResponse"]>[1]);
  }

  /** Redact a raw message for the given seat (null = not entitled). */
  redactMessageForSeat(
