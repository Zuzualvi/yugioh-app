--フォーチュンレディ・ライティー
--Fortune Lady Light
-- Edison override (A5): Removed IsPreviousPosition(POS_FACEUP) from spcon.
-- Edison ruling: "Will trigger even if Fortune Lady Light left the field while face-down."
local s,id=GetID()
...
-- Edison: removed IsPreviousPosition(POS_FACEUP) — triggers even if face-down when removed
