// Inserts a "ZUH118 Interactive Deck" for both e2e users, directly into the
...
const require = createRequire("/workspace/yugioh-app/package.json");
const Database = require("better-sqlite3");
import { randomUUID } from "node:crypto";

const DB = process.env.DB_PATH ?? "/tmp/zuh118.db";
const NAME = "ZUH118 Interactive Deck";
