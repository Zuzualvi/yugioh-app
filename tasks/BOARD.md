...
- **Interactive Duel UI epic is ACTIVE** (closes residual-gap A1 / "Bug 3"). Phase 0 (typed decision protocol) ✅ DONE SHA `d9976070`; Phase 0.5 (mobile engineering spec) ✅ DONE SHA `1c9cc50`; Phase 1 (engine adapter + server relay) 🟡 IN PROGRESS; Phases 2–3 gated on Phase 1. See Stream 3 section below.
...
| 1     | **Engine adapter (ocgcore⇄contract) + server relay/persistence** — backend-only, additive contracts                                        | Backend Engineer (×2) | 0   | 🟡 IN PROGRESS         | `/workspace/specs/interactive-duel-phase1.md`                                                                                                                                                                 |
| 2     | **Responsive web UI** — desktop (§6/§7) + mobile (§15), all decision-kind panels                                                           | —                     | 1   | ⬜ TODO                | `docs/working/2026-07-16-mobile-duel-engineering-spec.md` §§6–7, 15                                                                                                                                           |
| 3     | **E2E** — plays a real turn on mobile + desktop viewports                                                                                  | QA                    | 2   | ⬜ TODO                | —                                                                                                                                                                                                             |
